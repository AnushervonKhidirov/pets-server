...
export type TokenOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"refreshToken" | "userId" | "expiredAt", ExtArgs["result"]["token"]>
...
export interface TokenDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const tokenWithRefreshTokenOnly = await prisma.token.findMany({ select: { refreshToken: true } })
   * 
   */
